...
export default function Sidebar({ projects, selectedId, onSelect, onDashboard, onAdmin, onMarketing, onDecisions, onPortfolio, onNewProject, view, collapsed, onToggleCollapse }) {
